...
var incompleteTaskHolder=document.querySelector(".list_incomplete");//ul of .list_incomplete
var completedTasksHolder=document.querySelector(".list_completed");//list_completed
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="task__input task__input_check";
    editInput.type="text";
    editInput.className="task__input task__input_text task__name";
...
//Mark task as incomplete.
    ...
    //Append the task list item to the .list_incomplete.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
